...
interface ExtendedDragEndEvent extends DragEndEvent {
  activeIndex: number;
  overIndex: number;
}

type SortableRootProps<T> = Omit<React.ComponentProps<typeof DndContext>, 'id'> & {
  value: T[];
  onValueChange?: (items: T[]) => void;
  onMove?: (event: ExtendedDragEndEvent) => void;
  strategy?: SortableContextProps['strategy'];
